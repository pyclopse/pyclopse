...
**Files:** `pyclawops/security/approvals.py`, `pyclawops/security/sandbox.py`,
`pyclawops/security/audit.py`

---

## Exec Approvals (`pyclawops/security/approvals.py`)
...
## Sandbox (`pyclawops/security/sandbox.py`)
...
## Audit Logger (`pyclawops/security/audit.py`)

Appends JSON-lines records to `~/.pyclawops/logs/audit.log`.
