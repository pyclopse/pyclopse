# pyclawops Self-Knowledge Index
...
## overview
What pyclawops is, the full request flow, startup sequence, and how all subsystems
connect. Start here.
...
## systems/mcp-tools
The pyclawops MCP server (port 8081): all tools, patterns, lifecycle, logging
...
PyclawAgentExecutor, and how external agents call pyclawops agents over HTTP.
