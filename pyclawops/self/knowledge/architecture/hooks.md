...
**Files:** `pyclawops/hooks/registry.py`, `pyclawops/hooks/events.py`,
`pyclawops/hooks/loader.py`, `pyclawops/hooks/bundled/`

The hook system is pyclawops's event-driven extension mechanism. It has two
...
## Hook Events (`pyclawops/hooks/events.py`)
...
## HookRegistry (`pyclawops/hooks/registry.py`)
...
## Bundled Hooks (`pyclawops/hooks/bundled/`)
...
Handler: `pyclawops/hooks/bundled/session-memory/handler.py`
...
Handler: `pyclawops/hooks/bundled/boot-md/handler.py`

---

## Hook Loader (`pyclawops/hooks/loader.py`)
