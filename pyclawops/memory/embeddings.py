...
:class:`~pyclawops.config.schema.EmbeddingConfig` object.
"""
...
logger = logging.getLogger("pyclawops.memory.embeddings")
...
class EmbeddingBackend(ABC):
    ...
    implementation based on the ``EmbeddingConfig`` section of the pyclawops
    config file.
    """
...
def make_embedding_backend(config: "EmbeddingConfig") -> Optional[EmbeddingBackend]:
    ...
    Args:
        config (EmbeddingConfig): Pydantic ``EmbeddingConfig`` object read
            from the pyclawops config file.
