"""Command sandboxing for pyclawops."""
...
from pyclawops.config.schema import SandboxConfig, DockerSandboxConfig
...
class NoSandbox(Sandbox):
    ...
    def __init__(self, config: Optional[SandboxConfig] = None) -> None:
        ...
        self._logger = logging.getLogger("pyclawops.sandbox")
...
class DockerSandbox(Sandbox):
    ...
    def __init__(
        ...
        self._logger = logging.getLogger("pyclawops.sandbox.docker")
...
def create_sandbox(config: SandboxConfig) -> Sandbox:
    ...
    Args:
        config (SandboxConfig): Sandbox configuration from the pyclawops config
            file.
...
class DockerContainerManager:
    ...
    def __init__(self, docker_config: Optional[DockerSandboxConfig] = None) -> None:
        ...
        """
        self.docker_config = docker_config or DockerSandboxConfig()
        self._logger = logging.getLogger("pyclawops.sandbox.docker.manager")
