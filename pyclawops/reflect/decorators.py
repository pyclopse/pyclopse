"""Reflection decorators for pyclawops.
...
def reflect_system(name: str) -> Callable[[T], T]:
    """Decorator: register *obj* as a named pyclawops system."""
...
def reflect_event(name: str, payload: dict[str, Any] | None = None) -> Callable[[T], T]:
    """Decorator: register *obj* as a named pyclawops event.
...
def reflect_command(name: str) -> Callable[[T], T]:
    """Decorator: register *obj* as a named pyclawops slash command handler.
