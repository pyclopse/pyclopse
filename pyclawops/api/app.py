"""FastAPI application for pyclawops."""
import logging
...
async def lifespan(app: FastAPI):
    ...
    """
    logger.info("Starting pyclawops API server...")
    yield
    logger.info("Shutting down pyclawops API server...")
...
def create_app(gateway: Optional[Any] = None) -> FastAPI:
    ...
    async def health_check():
        ...
        Returns:
            dict: ``{"status": "healthy", "service": "pyclawops"}``.
        """
        return {"status": "healthy", "service": "pyclawops"}
