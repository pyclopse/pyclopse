...
logger = logging.getLogger("pyclawops.usage")
...
class UsageMonitor:
    ...
    Args:
        ...
        config: :class:`~pyclawops.config.schema.UsageConfig` instance.
    """
...
def init_registry(providers_cfg) -> UsageRegistry:
    ...
    Args:
        providers_cfg: :class:`~pyclawops.config.schema.ProvidersConfig` instance.
