"""File watcher for pyclawops — polls files for mtime changes and fires async callbacks.
...
logger = logging.getLogger("pyclawops.watcher")
...
class FileWatcher:
    ...
    async def start(self) -> None:
        ...
        if self._task and not self._task.done():
            return
        self._task = asyncio.create_task(self._loop(), name="pyclawops-file-watcher")
        logger.info(
