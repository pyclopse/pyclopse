...
in pyclawops.yaml (e.g. providers.minimax.models.MiniMax-M2.5.concurrency).
...
from pyclawops.core.usage import ThrottledError, get_registry

logger = logging.getLogger("pyclawops.concurrency")
