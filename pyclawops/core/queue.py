...
Config is defined in ``pyclawops.config.schema`` (QueueMode, DropPolicy, QueueConfig).
...
from pyclawops.config.schema import DropPolicy, QueueConfig, QueueMode
...
class SessionMessageQueue:
    ...
    def __init__(
        ...
        self._logger = logging.getLogger(f"pyclawops.queue.{session_key}")
