...
class JobScheduler:
    ...
    def __init__(
        ...
        self._logger = logging.getLogger("pyclawops.jobs")
    ...
    def _cron_next(
        ...
        try:
            ...
            try:
                ...
                pyclawops_tz = ZoneInfo(self._default_tz)
                after_aware = after.replace(tzinfo=pyclawops_tz)
                ...
                next_local = next_cron.astimezone(pyclawops_tz).replace(tzinfo=None)
            except Exception:
    ...
    async def spawn_subagent(
        ...
        """
        from pyclawops.jobs.models import AgentRun, AtSchedule, DeliverNone, Job
