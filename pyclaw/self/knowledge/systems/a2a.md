...
A2A (Agent-to-Agent) is a protocol that lets external AI systems call pyclaw
...
- **version** — pyclaw package version
...
`session_mode` controls how A2A tasks map to pyclaw sessions:
...
## PyclawAgentExecutor (`pyclaw/a2a/executor.py`)
...
## mount_a2a_routes (`pyclaw/a2a/setup.py`)
...
silently disabled. All other pyclaw functionality is unaffected.

---

## Example: calling a pyclaw agent via A2A
