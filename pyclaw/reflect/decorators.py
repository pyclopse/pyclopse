"""Reflection decorators for pyclaw.
...
def reflect_system(name: str) -> Callable[[T], T]:
    """Decorator: register *obj* as a named pyclaw system."""
...
def reflect_event(name: str, payload: dict[str, Any] | None = None) -> Callable[[T], T]:
    """Decorator: register *obj* as a named pyclaw event.
...
def reflect_command(name: str) -> Callable[[T], T]:
    """Decorator: register *obj* as a named pyclaw slash command handler.
