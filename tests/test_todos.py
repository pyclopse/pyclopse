"""
Tests for the pyclaw TODO registry.
...
def api_client(tmp_path):
    ...
    from pyclaw.todos.store import TodoStore as TS
...
async def _pyclaw_session(home_dir: str, gateway_url: str = "http://localhost:19999"):
    env = {
        **os.environ,
        "HOME": home_dir,
...
async def test_mcp_tools_registered(tmp_path):
    ...
    params = await _pyclaw_session(str(tmp_path))
