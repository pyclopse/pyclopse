"""Tests for pyclopse.core.usage — UsageMonitor, UsageRegistry, init_registry."""
...
from pyclopse.core.usage import (
    ThrottledError,
    UsageMonitor,
    UsageRegistry,
    _resolve_path,
...
class TestInitRegistry:
    def _make_usage_cfg(self, endpoint="https://example.com/usage"):
        from pyclopse.config.schema import UsageConfig
        return UsageConfig(
            enabled=True,
            endpoint=endpoint,
            total_path="total",
    ...
    def test_creates_monitor_for_generic_provider_with_usage(self):
        from pyclopse.config.schema import GenericProviderConfig, ProvidersConfig
    ...
    def test_skips_disabled_usage(self):
        from pyclopse.config.schema import GenericProviderConfig, ProvidersConfig, UsageConfig
    ...
    def test_empty_providers_returns_empty_registry(self):
        from pyclopse.config.schema import ProvidersConfig
...
class TestUsageConfigSchema:
    ...
    def test_generic_provider_with_usage(self):
        from pyclopse.config.schema import GenericProviderConfig
...
class TestJobPriority:
    def test_default_priority_is_normal(self):
        from pyclopse.jobs.models import Job
