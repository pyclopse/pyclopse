...
class TestEmbeddingConfig:
    ...
    def test_embedded_in_memory_config(self):
        from pyclopse.config.schema import MemoryConfig
...
class TestMakeEmbeddingBackend:
    ...
    def test_returns_openai_backend(self):
        from pyclopse.config.schema import EmbeddingConfig
        from pyclopse.memory.embeddings import make_embedding_backend, OpenAIEmbeddingBackend
    ...
    def test_returns_gemini_backend(self):
        from pyclopse.config.schema import EmbeddingConfig
        from pyclopse.memory.embeddings import make_embedding_backend, GeminiEmbeddingBackend
    ...
    def test_returns_local_backend(self):
        from pyclopse.config.schema import EmbeddingConfig
        from pyclopse.memory.embeddings import make_embedding_backend, LocalEmbeddingBackend
...
class TestCosineSimilarity:
    ...
    def test_identical_vectors_score_one(self):
        from pyclopse.memory.embeddings import cosine_similarity
        v = [1.0, 0.0, 0.0]
...
class TestProviderConfigs:
    ...
    def test_openai_uses_model_from_config(self):
        from pyclopse.config.schema import EmbeddingConfig
        from pyclopse.memory.embeddings import OpenAIEmbeddingBackend
    ...
    def test_local_uses_base_url_from_config(self):
        from pyclopse.config.schema import EmbeddingConfig
        from pyclopse.memory.embeddings import LocalEmbeddingBackend
    ...
    def test_gemini_default_model(self):
        from pyclopse.config.schema import EmbeddingConfig
        from pyclopse.memory.embeddings import GeminiEmbeddingBackend
