...
class TestLoadFromSpecs:
    ...
    def test_loads_valid_spec(self):
        from pyclopse.channels.loader import load_from_specs
...
class TestDiscoverEntryPoints:
    ...
    def test_returns_empty_when_no_entry_points(self):
        from pyclopse.channels.loader import discover_entry_points
...
class TestPluginsConfigChannels:
    ...
    def test_defaults_to_empty_list(self):
        from pyclopse.config.schema import PluginsConfig
        cfg = PluginsConfig()
        assert cfg.channels == []
...
class TestGatewayChannelPluginWiring:
    ...
    def _make_gateway(self, specs=None):
        ...
        from pyclopse.config.schema import Config, AgentsConfig, SecurityConfig, PluginsConfig
        import time
