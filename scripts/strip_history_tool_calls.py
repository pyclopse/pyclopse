...
Finds every history.json and history_previous.json under ~/.pyclaw/agents/,
...
def main() -> None:
    ...
    parser.add_argument(
        "--agents-dir",
        default="~/.pyclaw/agents",
        help="Root agents directory (default: ~/.pyclaw/agents)",
    )
    ...
    # Import FA + pyclaw after confirming env is sane
    try:
    ...
    from pyclaw.agents.runner import _strip_tool_machinery, _trim_history_for_save
