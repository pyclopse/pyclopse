"""FastAgent provider wrapper - connects pyclopse to FastAgent server."""
...
logger = logging.getLogger("pyclopse.providers.fastagent")
...
class FastAgentProvider(Provider):
    ...
    For direct FastAgent integration within pyclopse, use the
    pyclopse.agents module instead.
    """
...
class DirectFastAgentProvider(Provider):
    ...
    This provider uses FastAgent directly within pyclopse,
    ...
    async def _ensure_agent(self):
        ...
        if self._agent is None:
            self._fast = self._FastAgent("pyclopse-provider")
