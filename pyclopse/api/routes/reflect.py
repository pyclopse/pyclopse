"""REST API routes for the pyclopse reflection system.
...
logger = logging.getLogger("pyclopse.api.reflect")
router = APIRouter()
...
async def reflect(
    ...
    """Query the pyclopse live architecture reflection registry."""
    from pyclopse.reflect import query as _query
    return _query(
...
async def reflect_source(module_path: str):
    ...
    Only paths within the pyclopse package are accessible.
    """
