"""Skill discovery and formatting for pyclopse.
...
Directory search order:
  1. Global:     ~/.pyclopse/skills/
  2. Per-agent:  ~/.pyclopse/agents/{agent_name}/skills/
...
def get_skill_dirs(
    ...
    Args:
        ...
        config_dir (str): Base pyclopse config directory. Defaults to
            ``"~/.pyclopse"``.
