...
Config is defined in ``pyclopse.config.schema`` (QueueMode, DropPolicy, QueueConfig).
...
from pyclopse.config.schema import DropPolicy, QueueConfig, QueueMode
...
class SessionMessageQueue:
    ...
    def __init__(
        ...
        self._logger = logging.getLogger(f"pyclopse.queue.{session_key}")
