...
in pyclopse.yaml (e.g. providers.minimax.models.MiniMax-M2.5.concurrency).
...
from pyclopse.core.usage import ThrottledError, get_registry

logger = logging.getLogger("pyclopse.concurrency")
