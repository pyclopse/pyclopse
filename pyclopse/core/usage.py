...
logger = logging.getLogger("pyclopse.usage")
...
class UsageMonitor:
    ...
    Args:
        ...
        config: :class:`~pyclopse.config.schema.UsageConfig` instance.
    """
...
def init_registry(providers_cfg) -> UsageRegistry:
    ...
    Args:
        providers_cfg: :class:`~pyclopse.config.schema.ProvidersConfig` instance.
