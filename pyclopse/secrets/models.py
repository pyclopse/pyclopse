...
class FileSecretDef(BaseModel):
    ...
    YAML example::
        ...
        secrets:
          DB_PASSWORD:
            source: file
            path: ~/.pyclopse/secrets/db.txt       # reads entire file
          TG_BOT_TOKEN:
            source: file
...
class ExecSecretDef(BaseModel):
    ...
    a JSON response on stdout::
        ...
        stdin:  {"protocolVersion": 1, "provider": "pyclopse", "ids": ["<id>"]}
...
class SecretsConfig(BaseModel):
    ...
    YAML example::
        ...
        secrets:
          ...
          TRADING_KEY:
            source: file
            path: ~/.pyclopse/secrets/trading.json
            id: /trading/api_key
    """
