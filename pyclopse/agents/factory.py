...
logger = logging.getLogger("pyclopse.agents.factory")
...
class FastAgentFactory:
    ...
    def compile_to_code(self, config: Optional[Dict[str, Any]] = None) -> str:
        ...
        lines = [
            '"""Auto-generated FastAgent code from pyclopse config."""',
            '',
            'import asyncio',
            'from fast_agent import FastAgent',
            '',
            ...
            'fast = FastAgent("pyclopse agents")',
            '',
        ]
    ...
    def create_from_config(
        ...
        self._fast_instance = FastAgent("pyclopse")
    ...
    def create_agent(
        ...
        Returns:
            FastAgent: The existing ``self._fast_instance`` or a new ``FastAgent("pyclopse")``
            instance.
        ...
        return self._fast_instance or FastAgent("pyclopse")
