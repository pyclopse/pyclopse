...
# Bundled hooks shipped with pyclopse
...
class HookLoader:
    ...
    Search order (later sources override earlier on name collision):
      1. Bundled  — pyclopse/hooks/bundled/
      2. Managed  — ~/.pyclopse/hooks/
    ...
    def __init__(
        ...
        Args:
            config_dir (str): Path to the pyclopse config directory. The managed
                hooks sub-directory (``{config_dir}/hooks``) is automatically
                included in the search path. Defaults to "~/.pyclopse".
